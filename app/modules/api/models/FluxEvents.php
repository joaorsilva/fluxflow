...
class FluxEvents extends \Phalcon\Mvc\Model
{
    /**
     *
     * @var integer
    ...
    public function initialize()
    {
        ...
        $this->belongsTo('flux_event_types_id', '\FluxEventTypes', 'id', ['alias' => 'FluxEventTypes']);
        $this->belongsTo('flux_fluxes_id', '\FluxFluxes', 'id', ['alias' => 'FluxFluxes']);
        $this->belongsTo('flux_messages_id', '\FluxMessages', 'id', ['alias' => 'FluxMessages']);
    }
    ...
    public function columnMap()
    {
        return [
            'id' => 'id',
            'flux_event_types_id' => 'flux_event_types_id',
            'flux_fluxes_id' => 'flux_fluxes_id',
            'flux_messages_id' => 'flux_messages_id',
            'active' => 'active',
