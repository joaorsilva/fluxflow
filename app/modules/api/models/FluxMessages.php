...
class FluxMessages extends \Phalcon\Mvc\Model
{
    /**
     *
     * @var integer
    ...
    public function initialize()
    {
        ...
        $this->belongsTo('destination_id', '\CntContacts', 'id', ['alias' => 'CntContacts']);
        ...
        $this->hasMany('id', 'FluxEvents', 'flux_messages_id', ['alias' => 'FluxEvents']);
    }
     ...
     * @return FluxMessages[]|FluxMessages     */
