...
class UserAssignedOrganizations extends \Phalcon\Mvc\Model
{
    /**
     *
     * @var integer
    ...
    {
        return 'user_assigned_organizations';
    }
     ...
     * @return UserAssignedOrganizations[]|UserAssignedOrganizations     */
     ...
     *
     * @param mixed $parameters
     * @return UserAssignedOrganizations     */
    public static function findFirst($parameters = null)
    {
        return parent::findFirst($parameters);
    }

    public static function findUserOrganizations($userId)
    {
        $parameters = [
            'conditions'    => "user_users_id = ?1 AND active > ?2 AND deleted = ?3",
            'bind'          => [
                1   => $userId,
                2   => 0,
                3   => 0
