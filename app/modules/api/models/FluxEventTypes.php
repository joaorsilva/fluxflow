...
class FluxEventTypes extends \Phalcon\Mvc\Model
{
    /**
     *
     * @var integer
    ...
    public function initialize()
    {
        ...
        $this->hasMany('id', 'FluxEvents', 'flux_event_types_id', ['alias' => 'FluxEvents']);
    }
     ...
     * @return FluxEventTypes[]|FluxEventTypes     */
