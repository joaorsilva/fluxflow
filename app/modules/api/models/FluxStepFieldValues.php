...
class FluxStepFieldValues extends \Phalcon\Mvc\Model
{
    /**
     *
     * @var integer
     ...
     *
     * @var float 
     * @Column(type="float", length=15,3, nullable=true)
     */
    public $val_decimal;
    ...
    public function initialize()
    {
        ...
        $this->belongsTo('flux_fluxes_id', '\FluxFluxes', 'id', ['alias' => 'FluxFluxes']);
        $this->belongsTo('flux_step_fields_id', '\FluxStepFields', 'id', ['alias' => 'FluxStepFields']);
    }
     ...
     * @return FluxStepFieldValues[]|FluxStepFieldValues     */
    ...
    public function columnMap()
    {
        return [
            'id' => 'id',
            'flux_fluxes_id' => 'flux_fluxes_id',
            'flux_step_fields_id' => 'flux_step_fields_id',
            'val_int' => 'val_int',
            'val_char' => 'val_char',
            'val_text' => 'val_text',
            'val_bool' => 'val_bool',
