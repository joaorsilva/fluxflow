...
class FluxBoards extends \Phalcon\Mvc\Model
{
    /**
     *
     * @var integer
    ...
    public function initialize()
    {
        ...
        $this->hasMany('id', 'FluxFlows', 'flux_boards_id', ['alias' => 'FluxFlows']);
        $this->hasMany('id', 'FluxFluxes', 'flux_boards_id', ['alias' => 'FluxFluxes']);
        $this->hasMany('id', 'FluxSteps', 'flux_boards_id', ['alias' => 'FluxSteps']);
    }
