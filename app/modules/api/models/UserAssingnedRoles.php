...
class UserAssingnedRoles extends \Phalcon\Mvc\Model
{
    /**
     *
     * @var integer
     ...
     * @return UserAssingnedRoles[]|UserAssingnedRoles     */
     ...
     *
     * @param mixed $parameters
     * @return UserAssingnedRoles     */
    public static function findFirst($parameters = null)
    {
        return parent::findFirst($parameters);
    }

    public static function findUserRoles($organizationId, $userId)
    {
        $parameters = [
            'conditions'    => "unit_organizations_id=?1 AND user_users_id = ?2 AND active > ?3 AND deleted = ?4",
            'bind'          => [
                1   => $organizationId,
                2   => $userId,
                3   => 0,
