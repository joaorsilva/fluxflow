...
class FluxSteps extends \Phalcon\Mvc\Model
{
    /**
     *
     * @var integer
    ...
    public function initialize()
    {
        ...
        $this->hasMany('id', 'FluxFlows', 'flux_steps_id', ['alias' => 'FluxFlows']);
        $this->hasMany('id', 'FluxFluxes', 'flux_steps_id', ['alias' => 'FluxFluxes']);
        $this->hasMany('id', 'FluxStepFields', 'flux_steps_id', ['alias' => 'FluxStepFields']);
    }
