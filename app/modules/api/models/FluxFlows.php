...
class FluxFlows extends \Phalcon\Mvc\Model
{
    /**
     *
     * @var integer
     ...
     * @Column(type="integer", length=10, nullable=false)
     */
    public $destination_organizations_id;
    ...
    public function initialize()
    {
        ...
        $this->belongsTo('deatination_boards_id', '\DeatinationBoards', 'id', ['alias' => 'DeatinationBoards']);
        ...
        $this->belongsTo('destination_organizations_id', '\Unitorganizations', 'id', ['alias' => 'Unitorganizations']);
    }
    ...
    public function columnMap()
    {
        return [
            ...
            'destination_organizations_id' => 'destination_organizations_id',
            'deatination_boards_id' => 'deatination_boards_id',
            'destination_steps_id' => 'destination_steps_id',
            'active' => 'active',
