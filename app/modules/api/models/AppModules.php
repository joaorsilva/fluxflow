...
class AppModules extends \Phalcon\Mvc\Model
{
    ...
    public function initialize()
    {
        ...
        $this->hasMany('id', 'AppActions', 'app_modules_id', ['alias' => 'AppActions']);
        $this->hasMany('id', 'AppControllers', 'app_modules_id', ['alias' => 'AppControllers']);
        $this->hasMany('id', 'UserRolePermissions', 'app_modules_id', ['alias' => 'UserRolePermissions']);
    }
