...
class FluxFieldTypes extends \Phalcon\Mvc\Model
{
    /**
     *
     * @var integer
    ...
    public function initialize()
    {
        ...
        $this->hasMany('id', 'FluxStepFields', 'flux_field_types_id', ['alias' => 'FluxStepFields']);
    }
     ...
     * @return FluxFieldTypes[]|FluxFieldTypes     */
