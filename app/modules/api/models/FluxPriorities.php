...
class FluxPriorities extends \Phalcon\Mvc\Model
{
    /**
     *
     * @var integer
    ...
    public function initialize()
    {
        ...
        $this->hasMany('id', 'FluxFluxes', 'flux_priorities_id', ['alias' => 'FluxFluxes']);
    }
     ...
     * @return FluxPriorities[]|FluxPriorities     */
