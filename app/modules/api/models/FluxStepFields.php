...
class FluxStepFields extends \Phalcon\Mvc\Model
{
    /**
     *
     * @var integer
    ...
    public function initialize()
    {
        ...
        $this->belongsTo('parent_id', '\FluxStepFields', 'id', ['alias' => 'FluxStepFields']);
        $this->belongsTo('flux_steps_id', '\FluxSteps', 'id', ['alias' => 'FluxSteps']);
        $this->belongsTo('flux_field_types_id', '\FluxFieldTypes', 'id', ['alias' => 'FluxFieldTypes']);
        ...
        $this->hasMany('id', 'FluxStepFieldValues', 'flux_step_fields_id', ['alias' => 'FluxStepFieldValues']);
        $this->hasMany('id', 'FluxStepFields', 'parent_id', ['alias' => 'FluxStepFields']);
    }
     ...
     * @return FluxStepFields[]|FluxStepFields     */
