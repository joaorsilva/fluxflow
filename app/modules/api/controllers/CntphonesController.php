...
use Fluxflow\Modules\Api\Models\CntPhones;

class CntphonesController extends ControllerBase 
{
    /*
    ...
    public function newAction()
    {
        ...
        if( 
            ...
            || !isset($post['geo_country_id'])
            || !isset($post['phone'])
        ) 
            $code = 400;
        
        $resource = new CntPhones();
    ...
    public function updateAction($id)
    {
        ...
        $resource = CntPhones::findFirst($id);
        if( !$record )
            $code = 404;
        else 
        {
    ...
    public function indexAction()
    {
        ...
        $docFile = __DIR__ . "/docs/CntphonesController.php";
