...
use Fluxflow\Modules\Api\Models\GeoCountries;

class GeocountriesController extends ControllerBase 
{
    /*
    ...
    public function getAction($id)
    {
        ...
        {
            //Single record
            $record = GeoCountries::findFirst($id);
            if( !$record) 
                $code = 404;
            else
            {
        ...
        {
            //Recordset to find
            $requestSetting = $this->parseSettings( $this->request, GeoCountries );
            
            $struct = GeoCountries::findStructured($requestSetting);
    ...
    public function updateAction($id)
    {
        ...
        $resource = GeoCountries::findFirst($id);
        if( !$record )
            $code = 404;
        else 
        {
    ...
    public function indexAction()
    {
        ...
        $docFile = __DIR__ . "/docs/GeocountriesController.php";
