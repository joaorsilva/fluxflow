...
class UserassingnedrolesController extends ControllerBase 
{
    /*
    ...
    public function getAction($id)
    {
        ...
        {
            //Single record
            $record = UserAssingnedRoles::findFirst($id);
            if( !$record) 
                $code = 404;
            else
            {
        ...
        {
            //Recordset to find
            $requestSetting = $this->parseSettings( $this->request, UserAssingnedRoles );
            
            $struct = UserAssingnedRoles::findStructured($requestSetting);
    ...
    public function newAction()
    {
        ...
        if( 
            ...
            || !isset($post['user_users_id'])
        ) 
            $code = 400;
        
        $resource = new UserAssingnedRoles();
    ...
    public function updateAction($id)
    {
        ...
        $resource = UserAssingnedRoles::findFirst($id);
        if( !$record )
            $code = 404;
        else 
        {
    ...
    public function indexAction()
    {
        ...
        $docFile = __DIR__ . "/docs/UserassingnedrolesController.php";
