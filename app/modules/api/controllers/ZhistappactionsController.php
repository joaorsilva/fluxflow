...
use Fluxflow\Modules\Api\Models\ZhistAppActions;

class ZhistappactionsController extends ControllerBase 
{
    /*
    ...
    public function getAction($id)
    {
        ...
        {
            //Single record
            $record = ZhistAppActions::findFirst($id);
            if( !$record) 
                $code = 404;
            else
            {
        ...
        {
            //Recordset to find
            $requestSetting = $this->parseSettings( $this->request, ZhistAppActions );
            
            $struct = ZhistAppActions::findStructured($requestSetting);
    ...
    public function updateAction($id)
    {
        ...
        $resource = ZhistAppActions::findFirst($id);
        if( !$record )
            $code = 404;
        else 
        {
    ...
    public function indexAction()
    {
        ...
        $docFile = __DIR__ . "/docs/ZhistappactionsController.php";
