...
use Fluxflow\Modules\Api\Models\FluxFlows;

class FluxflowsController extends ControllerBase 
{
    /*
    ...
    public function getAction($id)
    {
        ...
        {
            //Recordset to find
            $requestSetting = $this->parseSettings( $this->request, FluxFlows );
            
            $struct = FluxFlows::findStructured($requestSetting);
    ...
    public function newAction()
    {
        ...
        if( 
            ...
            || !isset($post['destination_organizations_id'])
            || !isset($post['deatination_boards_id'])
            || !isset($post['destination_steps_id'])
        ) 
            $code = 400;
        
        $resource = new FluxFlows();
    ...
    public function updateAction($id)
    {
        ...
        $resource = FluxFlows::findFirst($id);
        if( !$record )
            $code = 404;
        else 
        {
    ...
    public function indexAction()
    {
        ...
        $docFile = __DIR__ . "/docs/FluxflowsController.php";
