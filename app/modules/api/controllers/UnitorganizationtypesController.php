...
use Fluxflow\Modules\Api\Models\UnitOrganizationTypes;

class UnitorganizationtypesController extends ControllerBase 
{
    /*
    ...
    public function getAction($id)
    {
        ...
        {
            //Single record
            $record = UnitOrganizationTypes::findFirst($id);
            if( !$record) 
                $code = 404;
            else
            {
        ...
        {
            //Recordset to find
            $requestSetting = $this->parseSettings( $this->request, UnitOrganizationTypes );
            
            $struct = UnitOrganizationTypes::findStructured($requestSetting);
    ...
    public function newAction()
    {
        ...
        $resource = new UnitOrganizationTypes();
    ...
    public function updateAction($id)
    {
        ...
        $resource = UnitOrganizationTypes::findFirst($id);
        if( !$record )
            $code = 404;
        else 
        {
    ...
    public function indexAction()
    {
        ...
        $docFile = __DIR__ . "/docs/UnitorganizationtypesController.php";
