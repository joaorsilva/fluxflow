...
use Fluxflow\Modules\Api\Models\ZhistCntContacts;

class ZhistcntcontactsController extends ControllerBase 
{
    /*
    ...
    public function getAction($id)
    {
        ...
        {
            //Single record
            $record = ZhistCntContacts::findFirst($id);
            if( !$record) 
                $code = 404;
            else
            {
        ...
        {
            //Recordset to find
            $requestSetting = $this->parseSettings( $this->request, ZhistCntContacts );
            
            $struct = ZhistCntContacts::findStructured($requestSetting);
    ...
    public function updateAction($id)
    {
        ...
        $resource = ZhistCntContacts::findFirst($id);
        if( !$record )
            $code = 404;
        else 
        {
    ...
    public function indexAction()
    {
        ...
        $docFile = __DIR__ . "/docs/ZhistcntcontactsController.php";
