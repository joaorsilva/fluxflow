...
class UnitorganizationsController extends ControllerBase 
{
    /*
    ...
    public function getAction($id)
    {
        ...
        {
            //Recordset to find
            $requestSetting = $this->parseSettings( $this->request, UnitOrganizations );
            
            $struct = UnitOrganizations::findStructured($requestSetting);
    ...
    public function newAction()
    {
        ...
        if( 
            !$post
            || !isset($post['unit_organization_types_id'])
            || !isset($post['name'])
        ) 
            $code = 400;
        
        $resource = new UnitOrganizations();
    ...
    public function updateAction($id)
    {
        ...
        $resource = UnitOrganizations::findFirst($id);
        if( !$record )
            $code = 404;
        else 
        {
    ...
    public function indexAction()
    {
        ...
        $docFile = __DIR__ . "/docs/UnitorganizationsController.php";
