...
use Fluxflow\Modules\Api\Models\ZhistUserAssingnedRoles;

class ZhistuserassingnedrolesController extends ControllerBase 
{
    /*
    ...
    public function getAction($id)
    {
        ...
        {
            //Single record
            $record = ZhistUserAssingnedRoles::findFirst($id);
            if( !$record) 
                $code = 404;
            else
            {
        ...
        {
            //Recordset to find
            $requestSetting = $this->parseSettings( $this->request, ZhistUserAssingnedRoles );
            
            $struct = ZhistUserAssingnedRoles::findStructured($requestSetting);
    ...
    public function newAction()
    {
        ...
        $resource = new ZhistUserAssingnedRoles();
        ...
        if(array_key_exists('user_users_id',$post))
        {
            if($post['user_users_id'] === "NULL")
            {
    ...
    public function updateAction($id)
    {
        ...
        $resource = ZhistUserAssingnedRoles::findFirst($id);
        if( !$record )
            $code = 404;
        else 
        {
    ...
    public function indexAction()
    {
        ...
        $docFile = __DIR__ . "/docs/ZhistuserassingnedrolesController.php";
