...
use Fluxflow\Modules\Api\Models\ZhistUserAssignedOrganizations;

class ZhistuserassignedorganizationsController extends ControllerBase 
{
    /*
    ...
    public function getAction($id)
    {
        ...
        {
            //Single record
            $record = ZhistUserAssignedOrganizations::findFirst($id);
            if( !$record) 
                $code = 404;
            else
            {
        ...
        {
            //Recordset to find
            $requestSetting = $this->parseSettings( $this->request, ZhistUserAssignedOrganizations );
            
            $struct = ZhistUserAssignedOrganizations::findStructured($requestSetting);
    ...
    public function newAction()
    {
        ...
        $resource = new ZhistUserAssignedOrganizations();
    ...
    public function updateAction($id)
    {
        ...
        $resource = ZhistUserAssignedOrganizations::findFirst($id);
        if( !$record )
            $code = 404;
        else 
        {
    ...
    public function indexAction()
    {
        ...
        $docFile = __DIR__ . "/docs/ZhistuserassignedorganizationsController.php";
