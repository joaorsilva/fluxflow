...
use Fluxflow\Modules\Api\Models\ZhistFluxEventTypes;

class ZhistfluxeventtypesController extends ControllerBase 
{
    /*
    ...
    public function getAction($id)
    {
        ...
        {
            //Single record
            $record = ZhistFluxEventTypes::findFirst($id);
            if( !$record) 
                $code = 404;
            else
            {
        ...
        {
            //Recordset to find
            $requestSetting = $this->parseSettings( $this->request, ZhistFluxEventTypes );
            
            $struct = ZhistFluxEventTypes::findStructured($requestSetting);
    ...
    public function newAction()
    {
        ...
        $resource = new ZhistFluxEventTypes();
    ...
    public function updateAction($id)
    {
        ...
        $resource = ZhistFluxEventTypes::findFirst($id);
        if( !$record )
            $code = 404;
        else 
        {
    ...
    public function indexAction()
    {
        ...
        $docFile = __DIR__ . "/docs/ZhistfluxeventtypesController.php";
