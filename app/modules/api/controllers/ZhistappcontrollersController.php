...
use Fluxflow\Modules\Api\Models\ZhistAppControllers;

class ZhistappcontrollersController extends ControllerBase 
{
    /*
    ...
    public function getAction($id)
    {
        ...
        {
            //Single record
            $record = ZhistAppControllers::findFirst($id);
            if( !$record) 
                $code = 404;
            else
            {
        ...
        {
            //Recordset to find
            $requestSetting = $this->parseSettings( $this->request, ZhistAppControllers );
            
            $struct = ZhistAppControllers::findStructured($requestSetting);
    ...
    public function newAction()
    {
        ...
        $resource = new ZhistAppControllers();
    ...
    public function updateAction($id)
    {
        ...
        $resource = ZhistAppControllers::findFirst($id);
        if( !$record )
            $code = 404;
        else 
        {
    ...
    public function indexAction()
    {
        ...
        $docFile = __DIR__ . "/docs/ZhistappcontrollersController.php";
