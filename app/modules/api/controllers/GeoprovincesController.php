...
use Fluxflow\Modules\Api\Models\GeoProvinces;

class GeoprovincesController extends ControllerBase 
{
    /*
    ...
    public function getAction($id)
    {
        ...
        {
            //Single record
            $record = GeoProvinces::findFirst($id);
            if( !$record) 
                $code = 404;
            else
            {
        ...
        {
            //Recordset to find
            $requestSetting = $this->parseSettings( $this->request, GeoProvinces );
            
            $struct = GeoProvinces::findStructured($requestSetting);
    ...
    public function updateAction($id)
    {
        ...
        $resource = GeoProvinces::findFirst($id);
        if( !$record )
            $code = 404;
        else 
        {
    ...
    public function indexAction()
    {
        ...
        $docFile = __DIR__ . "/docs/GeoprovincesController.php";
