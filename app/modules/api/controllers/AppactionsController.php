...
use Fluxflow\Modules\Api\Models\AppActions;
...
class AppactionsController extends ControllerBase 
{
    ...
    public function getAction($id)
    {
        ...
        {
            //Single record
            $record = AppActions::findFirst($id);
            if( !$record) 
                $code = 404;
            else
            {
        ...
        {
            //Recordset to find
            $requestSetting = $this->parseSettings( $this->request, AppActions );
            
            $struct = AppActions::findStructured($requestSetting);
    ...
    public function updateAction($id)
    {
        ...
        $resource = AppActions::findFirst($id);
        if( !$record )
            $code = 404;
        else 
        {
    ...
    public function indexAction()
    {
        ...
        $docFile = __DIR__ . "/docs/AppactionsController.php";
