...
use Fluxflow\Modules\Api\Models\ZhistGeoProvinces;

class ZhistgeoprovincesController extends ControllerBase 
{
    /*
    ...
    public function getAction($id)
    {
        ...
        {
            //Single record
            $record = ZhistGeoProvinces::findFirst($id);
            if( !$record) 
                $code = 404;
            else
            {
        ...
        {
            //Recordset to find
            $requestSetting = $this->parseSettings( $this->request, ZhistGeoProvinces );
            
            $struct = ZhistGeoProvinces::findStructured($requestSetting);
    ...
    public function newAction()
    {
        ...
        $resource = new ZhistGeoProvinces();
    ...
    public function updateAction($id)
    {
        ...
        $resource = ZhistGeoProvinces::findFirst($id);
        if( !$record )
            $code = 404;
        else 
        {
    ...
    public function indexAction()
    {
        ...
        $docFile = __DIR__ . "/docs/ZhistgeoprovincesController.php";
