...
class UserassignedorganizationsController extends ControllerBase 
{
    /*
    ...
    public function getAction($id)
    {
        ...
        {
            //Single record
            $record = UserAssignedOrganizations::findFirst($id);
            if( !$record) 
                $code = 404;
            else
            {
        ...
        {
            //Recordset to find
            $requestSetting = $this->parseSettings( $this->request, UserAssignedOrganizations );
            
            $struct = UserAssignedOrganizations::findStructured($requestSetting);
    ...
    public function newAction()
    {
        ...
        $resource = new UserAssignedOrganizations();
    ...
    public function updateAction($id)
    {
        ...
        $resource = UserAssignedOrganizations::findFirst($id);
        if( !$record )
            $code = 404;
        else 
        {
    ...
    public function indexAction()
    {
        ...
        $docFile = __DIR__ . "/docs/UserassignedorganizationsController.php";
