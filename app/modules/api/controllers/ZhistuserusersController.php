...
use Fluxflow\Modules\Api\Models\ZhistUserUsers;

class ZhistuserusersController extends ControllerBase 
{
    /*
    ...
    public function getAction($id)
    {
        ...
        {
            //Single record
            $record = ZhistUserUsers::findFirst($id);
            if( !$record) 
                $code = 404;
            else
            {
        ...
        {
            //Recordset to find
            $requestSetting = $this->parseSettings( $this->request, ZhistUserUsers );
            
            $struct = ZhistUserUsers::findStructured($requestSetting);
    ...
    public function newAction()
    {
        ...
        if(array_key_exists('surename',$post))
        {
            if($post['surename'] === "NULL")
            {
                $resource->surename = NULL;
            }
            else 
            {
        ...
        if(array_key_exists('last_login',$post))
        {
            if($post['last_login'] === "NULL")
            {
                $resource->last_login = NULL;
            }
            else 
            {
        ...
        if(array_key_exists('last_operation',$post))
        {
            if($post['last_operation'] === "NULL")
            {
                $resource->last_operation = NULL;
            }
            else 
            {
    ...
    public function updateAction($id)
    {
        ...
        $resource = ZhistUserUsers::findFirst($id);
        if( !$record )
            $code = 404;
        else 
        {
    ...
    public function indexAction()
    {
        ...
        $docFile = __DIR__ . "/docs/ZhistuserusersController.php";
