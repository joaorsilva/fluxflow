...
use Fluxflow\Modules\Api\Models\CntContactTypes;

class CntcontacttypesController extends ControllerBase 
{
    /*
    ...
    public function getAction($id)
    {
        ...
        {
            //Single record
            $record = CntContactTypes::findFirst($id);
            if( !$record) 
                $code = 404;
            else
            {
        ...
        {
            //Recordset to find
            $requestSetting = $this->parseSettings( $this->request, CntContactTypes );
            
            $struct = CntContactTypes::findStructured($requestSetting);
    ...
    public function updateAction($id)
    {
        ...
        $resource = CntContactTypes::findFirst($id);
        if( !$record )
            $code = 404;
        else 
        {
    ...
    public function indexAction()
    {
        ...
        $docFile = __DIR__ . "/docs/CntcontacttypesController.php";
