...
use Fluxflow\Modules\Api\Models\ZhistFluxFieldTypes;

class ZhistfluxfieldtypesController extends ControllerBase 
{
    /*
    ...
    public function getAction($id)
    {
        ...
        {
            //Single record
            $record = ZhistFluxFieldTypes::findFirst($id);
            if( !$record) 
                $code = 404;
            else
            {
        ...
        {
            //Recordset to find
            $requestSetting = $this->parseSettings( $this->request, ZhistFluxFieldTypes );
            
            $struct = ZhistFluxFieldTypes::findStructured($requestSetting);
    ...
    public function newAction()
    {
        ...
        $resource = new ZhistFluxFieldTypes();
    ...
    public function updateAction($id)
    {
        ...
        $resource = ZhistFluxFieldTypes::findFirst($id);
        if( !$record )
            $code = 404;
        else 
        {
    ...
    public function indexAction()
    {
        ...
        $docFile = __DIR__ . "/docs/ZhistfluxfieldtypesController.php";
