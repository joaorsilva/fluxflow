...
use Fluxflow\Modules\Api\Models\ZhistFluxStatus;

class ZhistfluxstatusController extends ControllerBase 
{
    /*
    ...
    public function getAction($id)
    {
        ...
        {
            //Single record
            $record = ZhistFluxStatus::findFirst($id);
            if( !$record) 
                $code = 404;
            else
            {
        ...
        {
            //Recordset to find
            $requestSetting = $this->parseSettings( $this->request, ZhistFluxStatus );
            
            $struct = ZhistFluxStatus::findStructured($requestSetting);
    ...
    public function updateAction($id)
    {
        ...
        $resource = ZhistFluxStatus::findFirst($id);
        if( !$record )
            $code = 404;
        else 
        {
    ...
    public function indexAction()
    {
        ...
        $docFile = __DIR__ . "/docs/ZhistfluxstatusController.php";
