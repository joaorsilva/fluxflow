...
use Fluxflow\Modules\Api\Models\FluxStepFieldValues;

class FluxstepfieldvaluesController extends ControllerBase 
{
    /*
    ...
    public function getAction($id)
    {
        ...
        {
            //Single record
            $record = FluxStepFieldValues::findFirst($id);
            if( !$record) 
                $code = 404;
            else
            {
        ...
        {
            //Recordset to find
            $requestSetting = $this->parseSettings( $this->request, FluxStepFieldValues );
            
            $struct = FluxStepFieldValues::findStructured($requestSetting);
    ...
    public function newAction()
    {
        ...
        if( 
            ...
            || !isset($post['flux_step_fields_id'])
        ) 
            $code = 400;
        
        $resource = new FluxStepFieldValues();
    ...
    public function updateAction($id)
    {
        ...
        $resource = FluxStepFieldValues::findFirst($id);
        if( !$record )
            $code = 404;
        else 
        {
    ...
    public function indexAction()
    {
        ...
        $docFile = __DIR__ . "/docs/FluxstepfieldvaluesController.php";
