...
use Fluxflow\Modules\Api\Models\UserRolePermissions;

class UserrolepermissionsController extends ControllerBase 
{
    /*
    ...
    public function getAction($id)
    {
        ...
        {
            //Single record
            $record = UserRolePermissions::findFirst($id);
            if( !$record) 
                $code = 404;
            else
            {
        ...
        {
            //Recordset to find
            $requestSetting = $this->parseSettings( $this->request, UserRolePermissions );
            
            $struct = UserRolePermissions::findStructured($requestSetting);
    ...
    public function updateAction($id)
    {
        ...
        $resource = UserRolePermissions::findFirst($id);
        if( !$record )
            $code = 404;
        else 
        {
    ...
    public function indexAction()
    {
        ...
        $docFile = __DIR__ . "/docs/UserrolepermissionsController.php";
