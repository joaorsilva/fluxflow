...
use Fluxflow\Modules\Api\Models\TestTable;
...
class TesttableController extends ControllerBase 
{
    ...
    public function getAction($id)
    {
        ...
        {
            //Recordset to find
            $requestSetting = $this->parseSettings( $this->request, TestTable );
            
            $struct = TestTable::findStructured($requestSetting);
    ...
    public function updateAction($id)
    {
        ...
        $resource = TestTable::findFirst($id);
        if( !$record )
            $code = 404;
        else 
        {
    ...
    public function indexAction()
    {
        ...
        $docFile = __DIR__ . "/docs/TesttableController.php";
