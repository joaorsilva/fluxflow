...
use Fluxflow\Modules\Api\Models\ZhistUnitOrganizationTypes;

class ZhistunitorganizationtypesController extends ControllerBase 
{
    /*
    ...
    public function getAction($id)
    {
        ...
        {
            //Single record
            $record = ZhistUnitOrganizationTypes::findFirst($id);
            if( !$record) 
                $code = 404;
            else
            {
        ...
        {
            //Recordset to find
            $requestSetting = $this->parseSettings( $this->request, ZhistUnitOrganizationTypes );
            
            $struct = ZhistUnitOrganizationTypes::findStructured($requestSetting);
    ...
    public function newAction()
    {
        ...
        $resource = new ZhistUnitOrganizationTypes();
    ...
    public function updateAction($id)
    {
        ...
        $resource = ZhistUnitOrganizationTypes::findFirst($id);
        if( !$record )
            $code = 404;
        else 
        {
    ...
    public function indexAction()
    {
        ...
        $docFile = __DIR__ . "/docs/ZhistunitorganizationtypesController.php";
