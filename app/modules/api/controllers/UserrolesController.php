...
class UserrolesController extends ControllerBase 
{
    /*
    ...
    public function getAction($id)
    {
        ...
        {
            //Recordset to find
            $requestSetting = $this->parseSettings( $this->request, UserRoles );
            
            $struct = UserRoles::findStructured($requestSetting);
    ...
    public function updateAction($id)
    {
        ...
        $resource = UserRoles::findFirst($id);
        if( !$record )
            $code = 404;
        else 
        {
    ...
    public function indexAction()
    {
        ...
        $docFile = __DIR__ . "/docs/UserrolesController.php";
