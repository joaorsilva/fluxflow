...
use Fluxflow\Modules\Api\Models\ZhistFluxSubjects;

class ZhistfluxsubjectsController extends ControllerBase 
{
    /*
    ...
    public function getAction($id)
    {
        ...
        {
            //Single record
            $record = ZhistFluxSubjects::findFirst($id);
            if( !$record) 
                $code = 404;
            else
            {
        ...
        {
            //Recordset to find
            $requestSetting = $this->parseSettings( $this->request, ZhistFluxSubjects );
            
            $struct = ZhistFluxSubjects::findStructured($requestSetting);
    ...
    public function newAction()
    {
        ...
        $resource = new ZhistFluxSubjects();
    ...
    public function updateAction($id)
    {
        ...
        $resource = ZhistFluxSubjects::findFirst($id);
        if( !$record )
            $code = 404;
        else 
        {
    ...
    public function indexAction()
    {
        ...
        $docFile = __DIR__ . "/docs/ZhistfluxsubjectsController.php";
