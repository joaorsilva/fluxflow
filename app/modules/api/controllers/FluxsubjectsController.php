...
use Fluxflow\Modules\Api\Models\FluxSubjects;

class FluxsubjectsController extends ControllerBase 
{
    /*
    ...
    public function getAction($id)
    {
        ...
        {
            //Single record
            $record = FluxSubjects::findFirst($id);
            if( !$record) 
                $code = 404;
            else
            {
        ...
        {
            //Recordset to find
            $requestSetting = $this->parseSettings( $this->request, FluxSubjects );
            
            $struct = FluxSubjects::findStructured($requestSetting);
    ...
    public function updateAction($id)
    {
        ...
        $resource = FluxSubjects::findFirst($id);
        if( !$record )
            $code = 404;
        else 
        {
    ...
    public function indexAction()
    {
        ...
        $docFile = __DIR__ . "/docs/FluxsubjectsController.php";
