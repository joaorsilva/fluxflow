...
use Fluxflow\Modules\Api\Models\ZhistUnitOrganizations;

class ZhistunitorganizationsController extends ControllerBase 
{
    /*
    ...
    public function getAction($id)
    {
        ...
        {
            //Single record
            $record = ZhistUnitOrganizations::findFirst($id);
            if( !$record) 
                $code = 404;
            else
            {
        ...
        {
            //Recordset to find
            $requestSetting = $this->parseSettings( $this->request, ZhistUnitOrganizations );
            
            $struct = ZhistUnitOrganizations::findStructured($requestSetting);
    ...
    public function newAction()
    {
        ...
        $resource = new ZhistUnitOrganizations();
        ...
        if(array_key_exists('unit_organization_types_id',$post))
        {
            if($post['unit_organization_types_id'] === "NULL")
            {
                $resource->unit_organization_types_id = NULL;
            }
            else 
            {
                $resource->unit_organization_types_id = $post['unit_organization_types_id'];
            }
        }
    ...
    public function updateAction($id)
    {
        ...
        $resource = ZhistUnitOrganizations::findFirst($id);
        if( !$record )
            $code = 404;
        else 
        {
    ...
    public function indexAction()
    {
        ...
        $docFile = __DIR__ . "/docs/ZhistunitorganizationsController.php";
