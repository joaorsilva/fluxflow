...
use Fluxflow\Modules\Api\Models\FluxSteps;

class FluxstepsController extends ControllerBase 
{
    /*
    ...
    public function getAction($id)
    {
        ...
        {
            //Recordset to find
            $requestSetting = $this->parseSettings( $this->request, FluxSteps );
            
            $struct = FluxSteps::findStructured($requestSetting);
    ...
    public function newAction()
    {
        ...
        if( 
            ...
            || !isset($post['step_order'])
        ) 
            $code = 400;
        
        $resource = new FluxSteps();
    ...
    public function updateAction($id)
    {
        ...
        $resource = FluxSteps::findFirst($id);
        if( !$record )
            $code = 404;
        else 
        {
    ...
    public function indexAction()
    {
        ...
        $docFile = __DIR__ . "/docs/FluxstepsController.php";
