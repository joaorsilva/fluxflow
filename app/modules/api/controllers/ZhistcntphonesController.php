...
use Fluxflow\Modules\Api\Models\ZhistCntPhones;

class ZhistcntphonesController extends ControllerBase 
{
    /*
    ...
    public function getAction($id)
    {
        ...
        {
            //Single record
            $record = ZhistCntPhones::findFirst($id);
            if( !$record) 
                $code = 404;
            else
            {
        ...
        {
            //Recordset to find
            $requestSetting = $this->parseSettings( $this->request, ZhistCntPhones );
            
            $struct = ZhistCntPhones::findStructured($requestSetting);
    ...
    public function newAction()
    {
        ...
        if(array_key_exists('geo_country_id',$post))
        {
            if($post['geo_country_id'] === "NULL")
            {
                $resource->geo_country_id = NULL;
            }
            else 
            {
    ...
    public function updateAction($id)
    {
        ...
        $resource = ZhistCntPhones::findFirst($id);
        if( !$record )
            $code = 404;
        else 
        {
    ...
    public function indexAction()
    {
        ...
        $docFile = __DIR__ . "/docs/ZhistcntphonesController.php";
