...
use Fluxflow\Modules\Api\Models\ZhistAppModules;

class ZhistappmodulesController extends ControllerBase 
{
    /*
    ...
    public function getAction($id)
    {
        ...
        {
            //Single record
            $record = ZhistAppModules::findFirst($id);
            if( !$record) 
                $code = 404;
            else
            {
        ...
        {
            //Recordset to find
            $requestSetting = $this->parseSettings( $this->request, ZhistAppModules );
            
            $struct = ZhistAppModules::findStructured($requestSetting);
    ...
    public function updateAction($id)
    {
        ...
        $resource = ZhistAppModules::findFirst($id);
        if( !$record )
            $code = 404;
        else 
        {
    ...
    public function indexAction()
    {
        ...
        $docFile = __DIR__ . "/docs/ZhistappmodulesController.php";
