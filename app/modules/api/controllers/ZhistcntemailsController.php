...
use Fluxflow\Modules\Api\Models\ZhistCntEmails;

class ZhistcntemailsController extends ControllerBase 
{
    /*
    ...
    public function getAction($id)
    {
        ...
        {
            //Single record
            $record = ZhistCntEmails::findFirst($id);
            if( !$record) 
                $code = 404;
            else
            {
        ...
        {
            //Recordset to find
            $requestSetting = $this->parseSettings( $this->request, ZhistCntEmails );
            
            $struct = ZhistCntEmails::findStructured($requestSetting);
    ...
    public function updateAction($id)
    {
        ...
        $resource = ZhistCntEmails::findFirst($id);
        if( !$record )
            $code = 404;
        else 
        {
    ...
    public function indexAction()
    {
        ...
        $docFile = __DIR__ . "/docs/ZhistcntemailsController.php";
