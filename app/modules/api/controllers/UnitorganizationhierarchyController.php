...
class UnitorganizationhierarchyController extends ControllerBase 
{
    /*
    ...
    public function getAction($id)
    {
        ...
        {
            //Single record
            $record = UnitOrganizationHierarchy::findFirst($id);
            if( !$record) 
                $code = 404;
            else
            {
        ...
        {
            //Recordset to find
            $requestSetting = $this->parseSettings( $this->request, UnitOrganizationHierarchy );
            
            $struct = UnitOrganizationHierarchy::findStructured($requestSetting);
    ...
    public function newAction()
    {
        ...
        if( 
            ...
            || !isset($post['unit_parent_child_id'])
            || !isset($post['direction'])
        ) 
            $code = 400;
        
        $resource = new UnitOrganizationHierarchy();
    ...
    public function updateAction($id)
    {
        ...
        $resource = UnitOrganizationHierarchy::findFirst($id);
        if( !$record )
            $code = 404;
        else 
        {
    ...
    public function indexAction()
    {
        ...
        $docFile = __DIR__ . "/docs/UnitorganizationhierarchyController.php";
