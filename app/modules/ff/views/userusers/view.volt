        <div class="right_col" role="main">
          <div class="">
            ...
            <div id="loading-content" class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="x_content">
                        <div id="loading-alert" class="alert alert-info" role="alert">
                            <i id="loading-spin" class="fa fa-spinner fa-spin"></i>&nbsp;<strong id="loading-title">Wait!</strong> <span id="loading-message">Your request is being processed.</span>
                        </div>
                    </div>
                </div>
            </div>

            <div id="page-content" class="row hidden">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
        ...
        <div class="hidden" id="page-parameters">
        <?php foreach($params as $key=>$value) { ?> 
            <div id="_param_<?php echo($key) ?>" data-value="<?php echo($value)?>"></div>
        <?php } ?> 
        </div>
        <?php } ?> 